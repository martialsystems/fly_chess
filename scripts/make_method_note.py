...
def build() -> Path:
    ...
    story.append(_p("Accountability (2026-09-20)", styles["h1"]))
    story.append(
        _p(
            "Results. Locked metrics are Python engine output at science lock "
            "b4c1875. They were not generated by a language model. Text. This "
            "note was drafted with Grok (xAI). The depositor reviewed the text "
            "against the locked logs and takes responsibility for it. No AI tool "
            "is an author.",
            styles["body"],
        )
    )
    story.append(_p("Cite this note (2026-09-20)", styles["h1"]))
    story.append(
        _p(
            "This PDF is a note, not a finding and not a software deposit. Cite "
            "the lock on the tree: "
            "https://github.com/martialsystems/fly_chess/tree/b4c1875 "
            "SWHID: swh:1:snp:24286532871ab538a678d750b1e91b7a9d8cc337 "
            "There is no DOI. The gist Artifact DOI cell stays empty until a "
            "10. identifier exists.",
            styles["body"],
        )
    )
